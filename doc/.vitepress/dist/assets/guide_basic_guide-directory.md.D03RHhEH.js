import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.CC18aqI2.js";const o=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"guide/basic/guide-directory.md","filePath":"guide/basic/guide-directory.md","lastUpdated":1720051796000}'),l={name:"guide/basic/guide-directory.md"},p=n(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><p>完整版目录结构 📚</p><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">├─ .husky # 代码提交前校验配置文件</span></span>
